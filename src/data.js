...
import phuquoc2 from "./assets/phuquoc2.webp";
import hagiang1 from "./assets/hagiang1.jpg";
import hagiang2 from "./assets/hagiang2.jpg";
import hagiang3 from "./assets/hagiang3.webp";
import mocchau1 from "./assets/mocchau1.webp";
import mocchau2 from "./assets/mocchau2.jpg";
import hanoi1 from "./assets/hanoi1.webp";
import hanoi2 from "./assets/hanoi2.webp";
import hanoi3 from "./assets/hanoi3.jpg";
import hanoi4 from "./assets/hanoi4.jpg";
import hanoi5 from "./assets/hanoi5.jpg";
import cantho1 from "./assets/cantho1.jpg";
import cantho2 from "./assets/cantho2.jpg";
import cantho3 from "./assets/cantho3.jpg";
import cantho4 from "./assets/cantho4.jpeg";
import cantho5 from "./assets/cantho5.jpg";
import cantho6 from "./assets/cantho4.jpg";

import hcm1 from "./assets/hcm1.jpg";
import hcm2 from "./assets/hcm2.jpg";
import hcm3 from "./assets/hcm3.jpg";
import danang1 from "./assets/danang1.jpg";
import danang2 from "./assets/danang2.webp";
import danang3 from "./assets/danang3.jpg";
import hoian1 from "./assets/hoian1.jpg";
import hoian2 from "./assets/hoian2.jpg";
...
import travelLeisure from "./assets/blogs/TAL-fisherman-in-vietnam-WHENVIETNAM0124-53bac1777bc5497390ccc317e9c71295.webp";
import reuters from "./assets/blogs/reuters.jpg";
import abcNews from "./assets/blogs/download.webp";
import bradinginAsia from "./assets/blogs/Live-Fully-in-Vietnam-Branding-in-Asia.jpg";
...
// Variable names like halong1, bana2, etc., are kept as placeholders
// assuming they are defined elsewhere in your project.

export const tours = [
  {
    id: 1,
    name: "The Luxury Wellness Retreat",
    price: "$1800",
    imageSrc: phuquoc1, // Placeholder image variable
    imageAlt: "Luxury wellness retreat in Phu Quoc or Halong Bay",
    images: [phuquoc1, phuquoc2, halong3, halong4, halong5], // Placeholder images
    region: "Phu Quoc / Halong",
    duration: "7D6N",
    startDate: "Luxury", // Used as a 'tag'
    description: `An exclusive retreat designed to regenerate your mind and body. This journey includes private sunrise yoga sessions, bespoke spa treatments, and organic fine dining, all hosted at a 5-star private villa or luxury cruise. A purposeful journey to reconnect with yourself.`,
    itinerary: [
      {
        highLight: `Private Airport Transfer - 5-Star Accommodation - Daily Wellness`,
        details: [
          `Day 1: Private luxury airport transfer to your 5-star villa or cruise. Welcome consultation with wellness guide.`,
          `Day 2: Private sunrise yoga & meditation. Bespoke spa treatment. Afternoon at leisure.`,
          `Day 3: Organic cooking class & garden-to-table lunch.`,
          `Day 4-6: Choice of daily activities (e.g., private island hopping, nature walks, or advanced spa therapies).`,
          `Day 7: Final wellness session and private transfer to airport.`,
          `*Note: This is a sample itinerary. Your entire journey will be customized by your Reverie Travel consultant.*`,
        ],
      },
    ],
    included: [
      "Private luxury vehicle with chauffeur for all transfers.",
      "6 nights in 5-star villa or luxury cruise suite.",
      "All bespoke meals as specified (organic, fine dining).",
      "Private wellness guide and yoga instructor.",
      "All activities and spa treatments mentioned in the customized itinerary.",
      "Dedicated 24/7 Reverie Travel concierge.",
    ],
    excluded: [
      "International and domestic flights (can be arranged upon request).",
      "Alcoholic beverages and minibar.",
      "Personal expenses and gratuities.",
      "Additional spa treatments not in the pre-agreed program.",
    ],
    cancellationPolicy: [
      `If client cancels at least 30 day(s) in advance, there is a 10% administrative fee.`,
      `If client cancels between 15 and 29 day(s) in advance, there is a 50 percent cancellation fee.`,
      `If client cancels within 14 day(s) of the departure, there is a 100 percent cancellation fee.`,
    ],
    confirmationPolicy: [
      `A personal travel consultant will contact you within 12 hours of booking to begin customization.`,
      `A deposit is required to confirm bookings. Final payment is due 60 days before departure.`,
      `A detailed, personalized e-voucher and itinerary will be sent upon final confirmation.`,
    ],
    additionalInfo: [
      `This is a private journey, exclusively for your group.`,
      `All dietary requirements (vegan, gluten-free, etc.) will be catered to at a gourmet level.`,
      `Please advise any specific wellness goals or mobility needs at time of booking.`,
      `We highly recommend comprehensive travel insurance.`,
      `Operated by Reverie Travel's luxury division.`,
    ],
    averageRating: 5,
    numReviews: 2,
    reviews: [
      // Reviews modified to reflect a luxury experience
      {
        _id: "620cfc4608c82135e823a357",
        rating: 5,
        title: "The most relaxing week of our lives.",
        comment:
          "Reverie Travel handled everything. The villa, the private yoga... it was beyond 5-star. Worth every penny.",
        product: "620486f7facd223de7588b53",
        createdAt: "2025-02-06T13:29:42.150Z",
        user: { name: "Hieu Vu" /* ... */ },
      },
      {
        _id: "620cfc4608c82135e823a358",
        rating: 5,
        title: "Simply perfect.",
        comment:
          "The definition of luxury and personalization. We will be booking again.",
        product: "620486f7facd223de7588b53",
        createdAt: "2025-02-08T13:29:42.150Z",
  ...
  {
    id: 2,
    name: "The Hidden Charm Explorer",
    price: "$2100",
    imageSrc: hagiang1, // Placeholder image variable
    imageAlt: "Exploring Ha Giang Loop or Moc Chau",
    images: [hagiang1, hagiang2, hagiang3, mocchau1, mocchau2], // Placeholder images
    region: "Ha Giang / Moc Chau",
    duration: "10D9N",
    startDate: "Bespoke", // Used as a 'tag'
    description: `For the avid explorer. This is a fully tailor-made journey to the 'hidden charms' of Vietnam's northern highlands. We take you far from the crowds for a deep cultural immersion, staying in high-end eco-lodges and engaging in exclusive activities.`,
    itinerary: [
      {
        highLight: `Private 4x4 Vehicle - Expert Local Guide - Authentic Cultural Immersion`,
        details: [
          `Day 1-3: Arrive in Hanoi, private transfer to Ha Giang. Begin exploration via private 4x4.`,
          `Day 4-6: Journey through Dong Van Karst Plateau. Stay in luxury eco-lodges. Private guided treks to remote villages.`,
          `Day 7-8: Visit local artisan workshops (e.g., textile weaving) for a private, hands-on experience.`,
          `Day 9-10: Explore Moc Chau's tea plantations. Enjoy a farewell dinner with a local family before returning to Hanoi.`,
          `*Note: This is a sample itinerary. Your entire journey will be customized by your Reverie Travel consultant.*`,
        ],
      },
    ],
    included: [
      ...
      "9 nights in best-available luxury eco-lodges and boutique hotels.",
      "Expert, English-speaking private cultural guide.",
      "All meals (B, L, D) featuring local specialties.",
      "All entrance fees and exclusive activity permits.",
      "Community support fee for local villages.",
    ],
    excluded: [
      "International and domestic flights.",
      "Alcoholic beverages.",
      "Personal trekking gear (list will be provided).",
    ...
    additionalInfo: [
      `This is a private journey, exclusively for your group.`,
      `A good level of fitness is recommended for optional treks.`,
      `This tour operates in remote areas; amenities are luxury *for the region*.`,
      `Operated by Reverie Travel's bespoke adventure division.`,
    ],
    averageRating: 4.5,
    numReviews: 2,
    reviews: [
      {
        _id: "620cfc4608c82135e823a359",
        rating: 4.5,
        title: "We saw parts of Vietnam we never thought possible",
        comment:
          "The 4x4 was comfortable and our guide, Sinh, was amazing. The eco-lodge was stunning. A real adventure.",
        product: "620486f7facd223de7588b54",
        createdAt: "2025-03-10T13:29:42.150Z",
        user: { name: "John Smith" /* ... */ },
      },
      {
        _id: "620cfc4608c82135e823a360",
        rating: 5,
        title: "Incredible. Just incredible.",
        comment: "Best experience ever!",
        product: "620486f7facd223de7588b54",
        createdAt: "2025-03-12T13:29:42.150Z",
        user: { name: "Hieu Vu" /* ... */ },
      },
    ],
  },
  {
    id: 3,
    name: "The Family Immersion Journey",
    price: "$1600",
    imageSrc: hanoi1, // Placeholder image variable
    imageAlt: "Family enjoying a cultural workshop in Hanoi",
    images: [hanoi1, hanoi2, hanoi3, cantho1, cantho2], // Placeholder images
    region: "Hanoi / Mekong",
    duration: "8D7N",
    startDate: "Family", // Used as a 'tag'
    description: `A thoughtfully designed journey for family bonding and education. This tour is personalized for families with children, balancing cultural workshops in Hanoi (calligraphy, cooking) with ecological exploration in the Mekong Delta. All guides and 5-star resorts are child-friendly.`,
    itinerary: [
      {
        highLight: `Child-Friendly Guide - Private Workshops - 5-Star Family Suites`,
        details: [
          `Day 1-2: Arrive in Hanoi. Stay in a 5-star family suite. Private cyclo tour and water puppet show.`,
          `Day 3: Private family-friendly cooking class. Afternoon calligraphy workshop.`,
          `Day 4: Fly to Can Tho (Mekong). Check into a luxury riverside resort with a pool.`,
          `Day 5-6: Private sampan boat to explore floating markets. Visit a family-run coconut candy farm.`,
          `Day 7: Day at leisure at the resort. Farewell family dinner.`,
          `Day 8: Private transfer to airport for departure.`,
          `*Note: This is a sample itinerary. All activities will be customized based on your children's ages and interests.*`,
        ],
      },
    ],
    included: [
      "7 nights in 5-star family suites or connecting rooms.",
      "Private, child-friendly, English-speaking guide.",
      "Private luxury van for all transfers.",
      "Domestic flights (Hanoi - Can Tho).",
      "All meals and private workshops as mentioned.",
      "All entrance fees.",
    ],
    excluded: [
    ...
    confirmationPolicy: [
      `A family travel specialist will contact you within 12 hours to discuss your children's ages and interests.`,
      `A deposit is required to confirm bookings.`,
    ],
    additionalInfo: [
      `This is a private journey, exclusively for your family.`,
      `All vehicles will be equipped with child safety seats upon request.`,
      `We cater to all dietary needs, including picky eaters!`,
      `Operated by Reverie Travel's family division.`,
    ],
    averageRating: 5,
    numReviews: 1,
    reviews: [
      {
        _id: "620cfc4608c82135e823a361",
        rating: 5,
        title: "The kids loved it!",
        comment:
          "Our guide, Trang, was amazing with our children. The cooking class was a highlight. So well-organized!",
        product: "620486f7facd223de7588b55",
        createdAt: "2025-04-01T13:29:42.150Z",
        user: { name: "Anna Müller" /* ... */ },
      },
    ],
  },
  {
    id: 4,
    name: "The Epicurean's Journey",
    price: "$1500",
    imageSrc: hcm2, // Placeholder image variable
    imageAlt: "Gourmet culinary experience in Hanoi",
    images: [hcm2, hcm1, hcm3, hanoi4, hanoi5], // Placeholder images
    region: "Hanoi / HCM City",
    duration: "6D5N",
    startDate: "Culinary", // Used as a 'tag'
    description: `A journey designed for connoisseurs of food and culture. Experience Vietnam's two capitals of flavor, Hanoi and Ho Chi Minh City. Includes private guided street food tours, exclusive master cooking classes, and fine dining reservations at Vietnam's top restaurants.`,
    itinerary: [
      {
        highLight: `Private Culinary Guide - Master Cooking Class - Fine Dining`,
        details: [
          `Day 1-2: Arrive Hanoi. Private, curated street food tour. 5-star hotel stay.`,
          `Day 3: Private master cooking class with a renowned Vietnamese chef.`,
          `Day 4: Fly to Ho Chi Minh City. Explore the city's modern culinary scene.`,
          `Day 5: Private tour of Ben Thanh Market. Farewell dinner at a Michelin-guide restaurant.`,
          `Day 6: Departure.`,
          `*Note: This is a sample itinerary. All dining and classes will be customized to your palate.*`,
        ],
      },
    ],
    included: [
      "5 nights in 5-star luxury hotels.",
      "Private culinary expert guide.",
      "All meals, classes, and dining reservations as specified.",
      "Domestic flight (Hanoi - Ho Chi Minh City).",
    ...
    confirmationPolicy: [
      `A culinary travel specialist will contact you within 12 hours to discuss your preferences.`,
      `A deposit is required to confirm bookings.`,
    ],
    additionalInfo: [
      `This is a private journey, exclusively for your group.`,
      `Please advise all dietary allergies and preferences at time of booking.`,
      `Operated by Reverie Travel's culinary division.`,
    ],
    averageRating: 5,
    numReviews: 1,
    reviews: [
      {
        _id: "620cfc4608c82135e823a362",
        rating: 5,
        title: "A food lover's dream",
        comment:
          "We ate things we never would have found on our own. The master class was professional and fun. A+ service.",
        product: "620486f7facd223de7588b56",
        createdAt: "2025-02-15T13:29:42.150Z",
        user: { name: "Hieu Vu" /* ... */ },
      },
    ],
  },
  {
    id: 5,
    name: "The Central Coast Adventure",
    price: "$1900",
    imageSrc: danang3, // Placeholder image variable
    imageAlt: "Luxury beach villa in Da Nang",
    images: [danang3, danang1, danang2, hoian1, hoian2], // Placeholder images
    region: "Da Nang / Hoi An",
    duration: "8D7N",
    startDate: "Adventure", // Used as a 'tag'
    description: `Experience the perfect blend of high-adventure and coastal luxury. This journey includes a private jeep tour over the Hai Van Pass, exploring ancient Hoi An with a private historian, a round of golf at a top-rated course, and relaxing at a secluded 5-star beach villa.`,
    itinerary: [
      {
        highLight: `Private Beach Villa - Hai Van Pass Jeep Tour - Golf`,
        details: [
          `Day 1-2: Arrive Da Nang. Private transfer to your 5-star beach villa.`,
          `Day 3: Full-day private jeep tour over the stunning Hai Van Pass.`,
          `Day 4: Morning golf at a BRG or Vinpearl course (tee time included).`,
          `Day 5: Private historian-led walking tour of Hoi An Ancient Town.`,
          `Day 6-7: Days at leisure to enjoy the beach, villa pool, or optional activities.`,
          `Day 8: Departure.`,
          `*Note: This is a sample itinerary. Activities (golf, spa, etc.) can be fully customized.*`,
        ],
      },
    ],
    included: [
      "7 nights in a 5-star private beach villa.",
      "Private luxury vehicle for all transfers.",
      "Private guides for jeep tour and Hoi An tour.",
      "One (1) round of golf, including green fee and caddy.",
      "Daily gourmet breakfast.",
      "All entrance fees.",
    ],
    excluded: [
      "International and domestic flights.",
      "Lunches and dinners (to allow for flexibility).",
      "Golf club rentals.",
      "Gratuities.",
    ],
    cancellationPolicy: [
    ...
    confirmationPolicy: [
      `A travel consultant will contact you within 12 hours to confirm your preferences (e.g., golf tee times).`,
      `A deposit is required to confirm bookings.`,
    ],
    additionalInfo: [
      `This is a private journey, exclusively for your group.`,
      `We can substitute golf for additional spa treatments or adventure activities (e.g., diving).`,
      `Operated by Reverie Travel's luxury adventure division.`,
    ],
    averageRating: 4.5,
    numReviews: 1,
    reviews: [
      {
        _id: "620cfc4608c82135e823a363",
        rating: 4.5,
        title: "Amazing week in Da Nang",
        comment:
          "The private villa was heaven. The jeep tour was a highlight! Reverie's team was so professional.",
        product: "620486f7facd223de7588b57",
        createdAt: "2025-04-10T13:29:42.150Z",
        user: { name: "Hieu Vu" /* ... */ },
      },
    ],
  },
  {
    id: 6,
    name: "The Sustainable Mekong Expedition",
    price: "$1700",
    imageSrc: cantho3, // Placeholder image variable
    imageAlt: "Luxury eco-lodge in the Mekong Delta",
    images: [cantho3, cantho4, cantho5, cantho6, mekong4], // Placeholder images
    region: "Mekong Delta",
    duration: "7D6N",
    startDate: "Sustainable", // Used as a 'tag'
    description: `A purposeful journey focused on sustainable tourism and authentic local life. Stay in high-end eco-lodges, visit community projects supported by Reverie Travel, explore floating markets via private sampan, and learn traditional crafts from local artisans.`,
    itinerary: [
      {
        highLight: `Luxury Eco-Lodge - Private Sampan - Community Project Visit`,
        details: [
          `Day 1-2: Arrive HCM City, private transfer to Can Tho. Check into a luxury eco-lodge.`,
          `Day 3: Private, early-morning sampan boat to Cai Rang floating market.`,
          `Day 4: Visit a community-based tourism project supported by Reverie Travel.`,
          `Day 5: Private cycling tour through lush orchards and villages.`,
          `Day 6: Day at leisure at the eco-lodge (spa, pool, reading).`,
          `Day 7: Private transfer back to HCM City for departure.`,
          `*Note: This is a sample itinerary focused on relaxation and sustainable impact.*`,
        ],
      },
    ],
    included: [
      "6 nights in a premier luxury eco-lodge.",
      "Private vehicle and private sampan boat.",
      "Expert local guide focused on sustainability.",
      "All meals (B, L, D) featuring local, sustainable produce.",
      "All activities and community visits as mentioned.",
      "Donation to the local community project.",
    ],
    excluded: [
      "International and domestic flights.",
      "Alcoholic beverages.",
    ...
    confirmationPolicy: [
      `A sustainable travel specialist will contact you within 12 hours.`,
      `A deposit is required to confirm bookings.`,
    ],
    additionalInfo: [
      `This is a private journey, exclusively for your group.`,
      `This tour is for those who want to travel luxuriously while making a positive impact.`,
      `Operated by Reverie Travel's sustainable division.`,
    ],
    averageRating: 5,
    numReviews: 1,
    reviews: [
      {
        _id: "620cfc4608c82135e823a364",
        rating: 5,
        title: "Meaningful and beautiful",
        comment:
          "The eco-lodge was one of the best places I've ever stayed. Knowing our trip supported the local community made it even better. Thank you, Reverie.",
        product: "620486f7facd223de7588b58",
        createdAt: "2025-03-20T13:29:42.150Z",
        user: { name: "Hieu Vu" /* ... */ },
      },
    ],
  },
    ...
    reviews: [
      {
        ...
        product: "620486f7facd223de7588b53",
        createdAt: "2025-02-06T13:29:42.150Z",
        updatedAt: "2025-02-06T13:29:42.150Z",

        user: {
          email: "hieuvu0422@gmail.com",
          name: "Hieu Vu",
          role: "customer",
...
export const blogs = [
  ...
  },
  {
    ...
    url: `https://apnews.com/article/coronavirus-pandemic-lifestyle-health-travel-business-2a08a3c6e81956998c14e5e8adecaa38`,
    source: "ABC News",
    date: new Date(),
    timeToRead: 10,
  },

  {
    ...
    title: "The Best (and Worst) Times to Visit Vietnam, According to Experts",
    description:
      "Here's when to visit Vietnam for sunny weather, lower prices, and excellent sightseeing.",
    url: "https://www.travelandleisure.com/best-times-to-visit-vietnam-8546761",
  ...
  },
  {
    ...
    url: "https://www.reuters.com/markets/asia/vietnams-resort-island-welcomes-first-tourists-after-nearly-2-yrs-2025-11-20/",
    source: "Reuters",
    date: new Date(),
    timeToRead: 7,
  },

  {
    id: 6,
    imageSrc: placesHN,
    title: `Asia's Leading Destination 2025`,
    description: `Vietnam is announced as “Asia’s Leading Destination 2025” by The World Travel Awards.We are ready to welcome back visitors from all over the world!”`,
    url: "https://www.worldtravelawards.com/award-asias-leading-destination-2025",
    source: "WTA",
    date: new Date(),
    timeToRead: 9,
  },
